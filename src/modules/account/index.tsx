          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <View>
                ...
                <Text style={orderStyles.deliveryDate}>Delivered By : {formatDate(item?.deliveryDate)}</Text>
            ...
            ListEmptyComponent={
              <View>
                <Text style={orderStyles.emptyText}>{!user ? "LOGIN TO PLACE YOUR ORDERS" : "THERE ARE NO ORDERS FOR YOU!!"}</Text>
              </View>
            }
